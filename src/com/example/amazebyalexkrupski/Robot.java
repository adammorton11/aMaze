...
public interface Robot {
	 ...
	 * @throws Exception 
	 */
	boolean canSeeGoal(Direction direction) throws UnsupportedOperationException, Exception ;
	/**
	 ...
	 * @throws Exception 
	 */	
	boolean isAtJunction() throws UnsupportedOperationException, Exception ;
	/**
